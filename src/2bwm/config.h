 ...
 *6)emptycol         */
static const char *colors[] = {"#CF4737","#202020","#6f179c","#efbd68","#68ef94","#101010","#000000"};
...
static const uint8_t borders[] = {7,13,10,10};
...
static const char *filecmd[] = { "alacritty", "-e", "lf", NULL };
static const char *volup[] = { "/home/" USERNAME "/scripts/volup.sh", NULL };
static const char *voldown[] = { "/home/" USERNAME "/scripts/voldown.sh", NULL };
static const char *volmute[] = { "/home/" USERNAME "/scripts/volmute.sh", NULL };
static const char *scrfull[] = { "/home/" USERNAME "/scripts/scrfull.sh", NULL };
static const char *scrsel[] = { "/home/" USERNAME "/scripts/scrsel.sh", NULL };
///--Custom foo---///
...
//    {  MOD,               XK_t,          always_on_top,     {}},
    ...
    {  MOD |SHIFT,        XK_i,          start,             {.com = wincmd}},
    {  MOD ,              XK_t,          start,             {.com = termcmd}},
    {  MOD ,              XK_e,          start,             {.com = filecmd}},
    {  MOD ,              XK_s,          start,             {.com = scrfull}},
    {  MOD |SHIFT,        XK_s,          start,             {.com = scrsel}},
