...
static const char *MARK_FG[]  = { "Nsxiv.mark.foreground",     "#f1fa8c" };
#if HAVE_LIBFONTS
static const char *BAR_BG[]   = { "Nsxiv.bar.background",       "#CF4737" };
static const char *BAR_FG[]   = { "Nsxiv.bar.foreground",       "#101010" };
static const char *BAR_FONT[] = { "Nsxiv.bar.font",            "0xProto Nerd Font-14" };
